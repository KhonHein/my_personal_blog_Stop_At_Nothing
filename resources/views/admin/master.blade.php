    ...
    <div class="container-xxl bg-secondary p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class=" bg-secondary border-bottom navbar sticky navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <h5 class="text-black fw-bold d-flex m-auto">This is for All </h5>
                ...
                <a href="{{ route('admin#profilePage',Auth::user()->id) }}" class="btn btn-secondary text-black fs-4 fw-bold" title="profile" id="myProfile"><i class="fa-solid fa-circle-user"></i></a>
            </nav>
        ...
        <!-- Full Screen Search End -->
         ...
         <div class="container-fluid bg-secondary text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5 px-lg-5 border border-top">
                <div class="row g-5">
